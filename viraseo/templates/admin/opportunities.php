...
<div class="vs-wrap" dir="rtl">
  ...
  <div class="vs-tab-panel active" data-panel="linkopp">
    ...
    <table class="vs-table">
      <thead><tr><th>صفحه</th><th>نمایش</th><th>کلیک</th><th>میانگین جایگاه</th><th>لینک ورودی</th><th>عملیات</th></tr></thead>
      <tbody id="vs-linkopp-tbody"><tr><td colspan="6" class="vs-empty">دکمه «محاسبه فرصت‌ها» را بزنید.</td></tr></tbody>
    </table>
  </div>
