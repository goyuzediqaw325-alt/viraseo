...
class Dashboard {
    ...
    public function menus(): void {
        ...
        add_submenu_page($s,'اسکیمای خودکار','📋 اسکیما','manage_options',$s.'-schema',[$this,'page_schema']);
    ...
    public function page_schema(): void { include VIRASEO_DIR.'templates/admin/schema.php'; }
