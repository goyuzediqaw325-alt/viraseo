...
register_deactivation_hook(__FILE__, function() {
    if (function_exists('as_unschedule_all_actions')) {
        as_unschedule_all_actions('viraseo_rank_update');
    }
    flush_rewrite_rules();
});
...
add_action('plugins_loaded', function() {
    ...
    new \ViraSEO\Features\SerpInspector();
    new \ViraSEO\Features\RankMonitor();
    new \ViraSEO\Features\InternalSilo();
    new \ViraSEO\Features\TargetKeywords();
    new \ViraSEO\Features\Opportunities();
    new \ViraSEO\Features\ModernSeo();
    new \ViraSEO\Features\ActionPlan();
    new \ViraSEO\Features\AiAssistant();
    new \ViraSEO\Features\IndexStatus();
    new \ViraSEO\Features\KeywordStrategy();
    new \ViraSEO\Features\BacklinkCRM();
    new \ViraSEO\Features\OOSProtector();
    new \ViraSEO\Features\WooSeo();
    new \ViraSEO\Features\FacetedNav();
    new \ViraSEO\Features\TrafficForecaster();
    new \ViraSEO\Features\CoreWebVitals();
    new \ViraSEO\Features\Cannibalization();
    new \ViraSEO\Features\CrawlHealth();
...
add_action('admin_init', function() {
    if (get_option('viraseo_db_version') !== VIRASEO_VERSION) {
        (new \ViraSEO\Database\Schema())->create_all_tables();
        update_option('viraseo_db_version', VIRASEO_VERSION);
        flush_rewrite_rules();
    }
});
