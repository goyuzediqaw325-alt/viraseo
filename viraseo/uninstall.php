...
global $wpdb;
$tables = ['gsc_keywords','cannibalization','serp_analysis','serp_competitors','internal_links','orphan_pages','link_suggestions','backlinks','disavow','oos_log','keyword_discoveries','keyword_ideas','rank_tracking','ai_outputs','activity_log'];
